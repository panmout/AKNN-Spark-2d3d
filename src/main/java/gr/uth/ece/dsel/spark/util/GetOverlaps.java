...
public final class GetOverlaps implements Function<Tuple2<String, ArrayList<Tuple2<Point, PriorityQueue<IdDist>>>>, ArrayList<Tuple2<String, Tuple2<Point, Boolean>>>>
{
	...
	public GetOverlaps (HashMap<String, Integer> cell_tpoints, int k, String partitioning)
	{
		...
		this.outValue = new ArrayList<Tuple2<String, Tuple2<Point, Boolean>>>();
	}
	...
	@Override
	public final ArrayList<Tuple2<String, Tuple2<Point, Boolean>>> call (Tuple2<String, ArrayList<Tuple2<Point, PriorityQueue<IdDist>>>> input)
	{
		...
		for (Tuple2<Point, PriorityQueue<IdDist>> tuple: input._2) // read next <query point, neighbors list> tuple
		{
			...
			for (String cell: this.overlaps)
				this.outValue.add(new Tuple2<String, Tuple2<Point, Boolean>>(cell, new Tuple2<Point, Boolean>(qpoint, this.listComplete)));
		}
		
		return new ArrayList<Tuple2<String, Tuple2<Point, Boolean>>>(this.outValue);
	}
			...
			{				
				...
				if (z + R > ds && !top_level.contains(intQCell)) // above cell, excluding top level
				{
					...
					if (x + R > ds && !east_column.contains(intQCell)) // E (excluding east wall)
					{
						...
						if (AknnFunctions.square_distance(xq, zq, xce, zce) < R * R) // if ceiling-east cell acme is inside circle, above-east cell is overlapped
					...
					if (x < R && !west_column.contains(intQCell)) // W (excluding west wall)
					{
						...
						if (AknnFunctions.square_distance(xq, zq, xcw, zcw) < R * R) // if ceiling-west cell acme is inside circle, above-west cell is overlapped
							int_overlaps.add(intQCell - 1 + zfloor);
					}
					// y-z plane
					if (y + R > ds && !north_row.contains(intQCell)) // N (excluding north wall)
					{
						...
						if (AknnFunctions.square_distance(yq, zq, ycn, zcn) < R * R) // if ceiling-north cell acme is inside circle, above-north cell is overlapped
					...
					if (y < R && !south_row.contains(intQCell)) // S (excluding south wall)
					{
						...
						if (AknnFunctions.square_distance(yq, zq, ycs, zcs) < R * R) // if ceiling-south cell acme is inside circle, above-south cell is overlapped
							int_overlaps.add(intQCell - this.N + zfloor);
					}
					// x-y-z space
					if (x + R > ds && y + R > ds && !north_row.contains(intQCell) && !east_column.contains(intQCell)) // NE (excluding north wall and east wall)
					{
						...
						if (AknnFunctions.square_distance(xq, yq, zq, xcne, ycne, zcne) < R * R) // if ceiling-NE corner is inside sphere, above-NE cell is overlapped
					...
					if (x + R > ds && y < R && !south_row.contains(intQCell) && !east_column.contains(intQCell)) // SE (excluding south wall and east wall)
					{
						...
						if (AknnFunctions.square_distance(xq, yq, zq, xcse, ycse, zcse) < R * R) // if ceiling-SE corner is inside circle, above-SE cell is overlapped
							int_overlaps.add(intQCell - this.N + 1 + zfloor);
					}
					if (x < R && y + R > ds && !north_row.contains(intQCell) && !west_column.contains(intQCell)) // NW (excluding north wall and west wall)
					{
						...
						if (AknnFunctions.square_distance(xq, yq, zq, xcnw, ycnw, zcnw) < R * R) // if ceiling-NW corner is inside circle, above-NW cell is overlapped
							int_overlaps.add(intQCell + this.N - 1 + zfloor);
					}
					if (x < R && y < R && !south_row.contains(intQCell) && !west_column.contains(intQCell)) // SW (excluding south wall and west wall)
					{
						...
						if (AknnFunctions.square_distance(xq, yq, zq, xcsw, ycsw, zcsw) < R * R) // if ceiling-SW corner is inside circle, above-SW cell is overlapped
							int_overlaps.add(intQCell - this.N - 1 + zfloor);
					}
				}
				// z-axis cells below
				if (z < R && !bottom_level.contains(intQCell)) // below cell, excluding bottom level
				{
					...
					if (x + R > ds && !east_column.contains(intQCell)) // E (excluding east wall)
					{
						...
						if (AknnFunctions.square_distance(xq, zq, xfe, zfe) < R * R) // if floor-east cell acme is inside circle, below-east cell is overlapped
							int_overlaps.add(intQCell + 1 - zfloor);
					}
					if (x < R && !west_column.contains(intQCell)) // W (excluding west wall)
					{
						...
						if (AknnFunctions.square_distance(xq, zq, xfw, zfw) < R * R) // if floor-west cell acme is inside circle, below-west cell is overlapped
							int_overlaps.add(intQCell - 1 - zfloor);
					}
					// y-z plane
					if (y + R > ds && !north_row.contains(intQCell)) // N (excluding north wall)
					{
						...
						if (AknnFunctions.square_distance(yq, zq, yfn, zfn) < R * R) // if floor-north cell acme is inside circle, below-north cell is overlapped
							int_overlaps.add(intQCell + this.N - zfloor);
					}
					if (y < R && !south_row.contains(intQCell)) // S (excluding south wall)
					{
						...
						if (AknnFunctions.square_distance(yq, zq, yfs, zfs) < R * R) // if floor-south cell acme is inside circle, below-south cell is overlapped
							int_overlaps.add(intQCell - this.N - zfloor);
					}
					if (x + R > ds && y + R > ds && !north_row.contains(intQCell) && !east_column.contains(intQCell)) // NE (excluding north wall and east wall)
					{
						...
						if (AknnFunctions.square_distance(xq, yq, zq, xfne, yfne, zfne) < R * R) // if floor-NE corner is inside sphere, below-NE cell is overlapped
							int_overlaps.add(intQCell + this.N + 1 - zfloor);
					}
					if (x + R > ds && y < R && !south_row.contains(intQCell) && !east_column.contains(intQCell)) // SE (excluding south wall and east wall)
					{
						...
						if (AknnFunctions.square_distance(xq, yq, zq, xfse, yfse, zfse) < R * R) // if floor-SE corner is inside circle, below-SE cell is overlapped
							int_overlaps.add(intQCell - this.N + 1 - zfloor);
					}
					if (x < R && y + R > ds && !north_row.contains(intQCell) && !west_column.contains(intQCell)) // NW (excluding north wall and west wall)
					{
						...
						if (AknnFunctions.square_distance(xq, yq, zq, xfnw, yfnw, zfnw) < R * R) // if floor-NW corner is inside circle, below-NW cell is overlapped
							int_overlaps.add(intQCell + this.N - 1 - zfloor);
					}
					if (x < R && y < R && !south_row.contains(intQCell) && !west_column.contains(intQCell)) // SW (excluding south wall and west wall)
					{
						...
						if (AknnFunctions.square_distance(xq, yq, zq, xfsw, yfsw, zfsw) < R * R) // if floor-SW corner is inside circle, below-SW cell is overlapped
							int_overlaps.add(intQCell - this.N - 1 - zfloor);
					}
				}
			}
						...
						else
						{
							...
							if (i > iq && j == jq)
							{
								...
								else if (k < kq)
								{
									...
									{
										if (AknnFunctions.square_distance(xq, zq, i * ds, (k + 1) * ds) < R * R) // if also ceiling-west acme is inside circle
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
								// upper z level
								else // k > kq
								{
									if ((centers_dist_x < R + ds / 2) && (centers_dist_z < R + ds / 2)) // if centers on x-z plane are close enough
									{
										if (AknnFunctions.square_distance(xq, zq, i * ds, k * ds) < R * R) // if also floor-west acme is inside circle
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
							}
							...
							else if (i > iq && j > jq)
							{
								...
								if (k == kq)
								{
									...
									{
										if (AknnFunctions.square_distance(xq, yq, i * ds, j * ds) < R * R) // if also SW acme is inside circle
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
								// lower z level
								else if (k < kq)
								{
									...
									{
										if (AknnFunctions.square_distance(xq, yq, zq, i * ds, j * ds, (k + 1) * ds) < R * R) // if also ceiling-SW corner is inside sphere
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
								// upper z level
								else // k > kq
								{
									if ((centers_dist_x < R + ds / 2) && (centers_dist_y < R + ds / 2) && (centers_dist_z < R + ds / 2)) // if centers on x-y-z space are close enough
									{
										if (AknnFunctions.square_distance(xq, yq, zq, i * ds, j * ds, k * ds) < R * R) // if also floor-SW corner is inside sphere
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
							}
							...
							else if (i == iq && j > jq)
							{
								...
								else if (k < kq)
								{
									...
									{
										if (AknnFunctions.square_distance(yq, zq, j * ds, (k + 1) * ds) < R * R) // if also ceiling-south acme is inside circle
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
								// upper z level
								else // k > kq
								{
									if ((centers_dist_y < R + ds / 2) && (centers_dist_z < R + ds / 2)) // if centers on y-z plane are close enough
									{
										if (AknnFunctions.square_distance(yq, zq, j * ds, k * ds) < R * R) // if also floor-south acme is inside circle
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
							}
							...
							else if (i < iq && j > jq)
							{
								...
								if (k == kq)
								{
									if ((centers_dist_x < R + ds / 2) && centers_dist_y < R + ds / 2) // if centers on x-y plane are close enough
									{
										if (AknnFunctions.square_distance(xq, yq, (i + 1) * ds, j * ds) < R * R) // if also SE acme is inside circle
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
								// lower z level
								else if (k < kq)
								{
									if ((centers_dist_x < R + ds / 2) && (centers_dist_y < R + ds / 2) && (centers_dist_z < R + ds / 2)) // if centers on x-y-z space are close enough
									{
										if (AknnFunctions.square_distance(xq, yq, zq, (i + 1) * ds, j * ds, (k + 1) * ds) < R * R) // if also ceiling-SE corner is inside sphere
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
								// upper z level
								else // k > kq
								{
									if ((centers_dist_x < R + ds / 2) && (centers_dist_y < R + ds / 2) && (centers_dist_z < R + ds / 2)) // if centers on x-y-z space are close enough
									{
										if (AknnFunctions.square_distance(xq, yq, zq, (i + 1) * ds, j * ds, k * ds) < R * R) // if also floor-SE corner is inside sphere
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
							}
							...
							else if (i < iq && j == jq)
							{
								...
								else if (k < kq)
								{
									if ((centers_dist_x < R + ds / 2) && (centers_dist_z < R + ds / 2)) // if centers on x-z plane are close enough
									{
										if (AknnFunctions.square_distance(xq, zq, (i + 1) * ds, (k + 1) * ds) < R * R) // if also ceiling-east acme is inside circle
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
								// upper z level
								else // k > kq
								{
									if ((centers_dist_x < R + ds / 2) && (centers_dist_z < R + ds / 2)) // if centers on x-z plane are close enough
									{
										if (AknnFunctions.square_distance(xq, zq, (i + 1) * ds, k * ds) < R * R) // if also floor-east acme is inside circle
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
							}
							...
							else if (i < iq && j < jq)
							{
								...
								if (k == kq)
								{
									if ((centers_dist_x < R + ds / 2) && centers_dist_y < R + ds / 2) // if centers on x-y plane are close enough
									{
										if (AknnFunctions.square_distance(xq, yq, (i + 1) * ds, (j + 1) * ds) < R * R) // if also NE acme is inside circle
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
								// lower z level
								else if (k < kq)
								{
									if ((centers_dist_x < R + ds / 2) && (centers_dist_y < R + ds / 2) && (centers_dist_z < R + ds / 2)) // if centers on x-y-z space are close enough
									{
										if (AknnFunctions.square_distance(xq, yq, zq, (i + 1) * ds, (j + 1) * ds, (k + 1) * ds) < R * R) // if also ceiling-NE corner is inside sphere
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
								// upper z level
								else // k > kq
								{
									if ((centers_dist_x < R + ds / 2) && (centers_dist_y < R + ds / 2) && (centers_dist_z < R + ds / 2)) // if centers on x-y-z space are close enough
									{
										if (AknnFunctions.square_distance(xq, yq, zq, (i + 1) * ds, (j + 1) * ds, k * ds) < R * R) // if also floor-NE corner is inside sphere
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
							}
							...
							else if (i == iq && j < jq)
							{
								...
								else if (k < kq)
								{
									if ((centers_dist_y < R + ds / 2) && (centers_dist_z < R + ds / 2)) // if centers on y-z plane are close enough
									{
										if (AknnFunctions.square_distance(yq, zq, (j + 1) * ds, (k + 1) * ds) < R * R) // if also ceiling-north acme is inside circle
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
								// upper z level
								else // k > kq
								{
									if ((centers_dist_y < R + ds / 2) && (centers_dist_z < R + ds / 2)) // if centers on y-z plane are close enough
									{
										if (AknnFunctions.square_distance(yq, zq, (j + 1) * ds, k * ds) < R * R) // if also floor-north acme is inside circle
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
							}
							...
							else if (i > iq && j < jq)
							{
								...
								else if (k < kq)
								{
									if ((centers_dist_x < R + ds / 2) && (centers_dist_y < R + ds / 2) && (centers_dist_z < R + ds / 2)) // if centers on x-y-z space are close enough
									{
										if (AknnFunctions.square_distance(xq, yq, zq, i * ds, (j + 1) * ds, (k + 1) * ds) < R * R) // if also ceiling-NW corner is inside sphere
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
								// upper z level
								else // k > kq
								{
									if ((centers_dist_x < R + ds/2) && (centers_dist_y < R + ds/2) && (centers_dist_z < R + ds/2)) // if centers on x-y-z space are close enough
									{
										if (AknnFunctions.square_distance(xq, yq, zq, i * ds, (j + 1) * ds, k * ds) < R*R) // if also floor-NW corner is inside sphere
											this.overlaps.add(sq); // there is collision, add cell to overlaps
									}
								}
							}
